...
export function PublicFooter({content}:{content:SiteContent}){
  return <footer className="site-footer">
    <div className="footer-top">
      ...
      <nav className="footer-links" aria-label="Navegação do rodapé"><a href="/agenda" target="_self">Agenda</a><a href="/videos" target="_self">Vídeos</a><a href="/fotos" target="_self">Fotos</a><a href="/camisetas" target="_self">Camisetas</a><a href="/contato" target="_self">Contrate a banda</a><a href="/cms" target="_self">Painel</a></nav>
    </div>
